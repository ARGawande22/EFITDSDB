...
BEGIN
		...
		SELECT		Sevaarth_Id,
			...
			FROM OPENXML(@XMLDocumentHandle ,'/Employees/SevaarthYearly', 2) WITH
						   (Sevaarth_Id			nvarchar(15),
							...
							DOB_AsPerSevaarth	date	'DOB_AsPerSevaarth'	,
							Name_AsPerIT		nvarchar(50),
							DOB_AsPerIT			date	 'DOB_AsPerIT'	,
							Designation_Id		int			,
	...
	OPEN K
		FETCH NEXT FROM K INTO @Sevaarth_Id,@DDO_Code,@EMP_PANNo,@PAN_Status,@UID_No,@EID_No,@Name_AsPerSevaarth,@DOB_AsPerSevaarth,@Name_AsPerIT,
		@DOB_AsPerIT,@Designation_Id,@Designation,@DOJ,@DOR,@Contact_No,@Email_Id,@Gender_Id,@Address,@IsManual,@IsSeniorCitizen,@IsDCPS,@Account_No,
				...
				ELSE
				 BEGIN					
					...
					SET DDO_Code=CASE WHEN (@MaxVoucherDate IS Not NULL AND @MaxVoucherDate<@Vourcher_Date)
						...
						DBO_AsPerSevaarth=@DOB_AsPerSevaarth
