...
Create   Procedure [dbo].[TDS_sp_insupd24QvoucherData]
	@loginId INT
	,@xml24Q TEXT
	,@Status INT  OUTPUT
--***********************************************************
...
BEGIN
	...
	EXEC @XMLPrepared=sp_XML_preparedocument @XMLDocumentHandle OUTPUT,@xml24Q
	...
	INSERT INTO #SevaarthDetails(
		...
		SELECT		Sevaarth_Id,
			...
			FROM OPENXML(@XMLDocumentHandle ,'/SevaarthYearly', 2) WITH
						   (Sevaarth_Id			nvarchar(15),
	...
	OPEN K
		...
		BEGIN
			IF(@@FETCH_STATUS<>-2)
			BEGIN
				--[1]. Insert Employee Yearly Details.
				...
				--[2]. Insert Employee Gross Details.
				...
				--[3]. Insert Employee Gov Recoveries details
				...
				--[4]. Insert Employee Gov Non Recoveries details
