...
/****** Object:  View [dbo].[EmployeeDetails_v1]    Script Date: 30/10/2025 11:32:38 ******/
SET ANSI_NULLS ON
GO
...
CREATE     View [dbo].[EmployeeDetails_v1]
--***********************************************************
--***
...
AS
	...
	LEFT JOIN dbo.TDS_t_Designations d with(nolock) ON ed.Designation_Id=d.Designation_Id
